...
export function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer className="border-t border-border bg-surface/30 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center gap-6">
          ...
          >
            {socialLinks.map((social) => (
              <ExternalLink
                key={social.name}
                href={social.url}
                className="p-3 rounded-lg bg-surface border border-border hover:border-accent-primary hover:scale-110 transition-all no-underline"
          ...
          >
            ...
            <p className="mt-2">
              {t.footer.builtWith}{' '}
              <span className="text-accent-primary">Next.js 15</span>,{' '}
